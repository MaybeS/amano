...
from lib.box import match, log_sum_exp
...
class Loss(nn.Module):
    ...
    def __init__(self, num_classes: int,
                 overlap_thresh: float = .5,
                 prior_for_matching: bool = True,
                 background: int = 0,
        ...
        self.do_neg_mining = negative_mining
        self.negpos_ratio = sample_ratio
        self.neg_overlap = negative_overlap
