function pts_set = get_cube_pts_fisheye(calib ,rays_cube)
...
pts_set = {};
pts_set.front = ray2pix(calib, rays_front);
pts_set.behind = ray2pix(calib, rays_behind);
pts_set.up = ray2pix(calib, rays_up);
pts_set.down = ray2pix(calib, rays_down);
pts_set.left = ray2pix(calib, rays_left);
pts_set.right = ray2pix(calib, rays_right);
